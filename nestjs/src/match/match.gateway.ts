...
export class MatchGateway {
  ...
  powerUpPaddleSpeed(playerID: number) {
    if (playerID === 1)
      this.paddleSpeedMultiplierP1 = this.paddleSpeedMultiplierP1 + this.powerupStrength;
    else if (playerID === 2)
      this.paddleSpeedMultiplierP2 = this.paddleSpeedMultiplierP2 + this.powerupStrength;
  }
